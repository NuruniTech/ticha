...
function getSystemPrompt(
  ...
  const _e1HooksText = (() => {
    ...
    nane (eight):      "Did you know a spider has nane legs — eight of them — all moving at once?! Have you ever tried to count a real spider's legs? Would you be brave enough?"
    ...
    if (game === "body") return `BODY PARTS — vary your opening every time. Mix action, sensation, funny scenarios, and wow facts. Never open the same way twice.\n${dirNote}\n` + (isSwahili ? `    kichwa (head):    "Did you know your kichwa is the boss of your WHOLE body? Your brain inside sends orders to your feet, your hands, everything! What do you think your kichwa is telling your legs to do right now?"
    ...
    masikio (ears):   "Shhh — stop and listen for just one second. What can you hear right now? That is your masikio doing their job, without you even thinking about it! What is the most beautiful sound they have ever caught?"
    ...
    shingo (neck):    "Your shingo is holding up your heavy kichwa right now, without you even noticing! Did you know a twiga has a shingo so long it can reach the very top of a tall tree? Which animal do you think has the longest shingo?"
    bega (shoulder):  "Roll both bega backwards — big slow circles! Feel that joint moving? Without your bega, your whole mkono could not swing or reach or throw! Which sport uses your bega the most?"
    ...
    moyo (heart):     "Press your mkono gently on your kifua — feel that beat? That is your moyo, and it has NEVER stopped since the day you were born! Is it beating fast or slow right now — and what do you think makes it beat the fastest?"
    ...
    damu (blood):     "Right this second, your damu is travelling through your ENTIRE body — from your moyo all the way to your toes and back — non-stop! Have you ever seen a tiny drop of damu from a small cut?"` : `    kichwa (head):    "Je, unajua kwamba kichwa chako ndicho mkuu wa mwili wako wote? Ubongo wako ndani unatuma amri kwa miguu yako, mikono yako, kila kitu! Unafikiri kichwa chako kinawaambia nini miguu yako sasa hivi?"
    ...
    shingo (neck):    "Shingo yako inashikilia kichwa chako kizito sasa hivi, bila hata kujua! Je, unajua kwamba twiga ana shingo ndefu kiasi kwamba inaweza kufikia juu ya mti mrefu sana? Mnyama gani unadhani ana shingo ndefu zaidi?"
    bega (shoulder):  "Zungusha mabega yako yote mawili nyuma — miduara mipana! Uhisi mfumo ule ukisogea? Bila mabega yako, mkono wako wote haukuweza kugeuka, kufikia au kutupa! Ni mchezo gani unaotumia mabega zaidi?"
    ...
    moyo (heart):     "Bonyeza mkono wako polepole juu ya kifua chako — uhisi ule mpigo? Hiyo ni moyo wako, na HAUJAACHA tangu siku uliyozaliwa! Je, unapiga haraka au polepole sasa hivi — na unafikiria nini kinakufanya upige haraka zaidi?"
    ...
    mwalimu:    "Every single thing you know — how to read, count, write, speak — someone patient stood in front of you and taught you. That person is a mwalimu! Who is your absolute favourite mwalimu, and what is one thing they taught you that you will never forget?"
  ...
  const _e3QuestionsText = (() => {
    ...
    masikio:  "Cover your masikio with both hands — what happens to the sound? What can you still hear?"
    ...
    mguu:     "Stomp one mguu on the ground — can you feel it? If your mguu could run anywhere, where would you go?"
    mgongo:   "Sit up tall — feel your mgongo holding you straight! Can you think of an animal with a very long mgongo?"
    ...
    zambarau: "Have you ever tasted biringanya? It is zambarau — do you like that colour?"
...
STORY DROP (colors):  "I looked out the window and the whole sky turned... what colour is the sky? What do we call it?"
