...
function getSystemPrompt(
  ...
  const _e1HooksText = (() => {
    ...
    kidole (finger):  "Hold up your longest kidole right now — look at it! Kidole means finger — the ones on your hand. Each tiny kidole has its own job — pointing, drawing, pressing, counting! How many fingers do you have on BOTH hands altogether?"
    ...
    shingo (neck):    "Your shingo is holding up your heavy head right now, without you even noticing! A giraffe has a shingo so long it can reach the very top of a tall tree — which animal do you think has the longest shingo in the world?"
    bega (shoulder):  "Roll both bega backwards in big slow circles — without your bega, your whole arm could not swing, reach, or throw! Which sport uses your bega the most?"
    kifua (chest):    "Put your hand on your kifua right now — stay still and feel! What is happening in there? Your heart and your lungs are working every single second, even right now, even when you sleep!"
    moyo (heart):     "Press your hand gently on your chest and feel your moyo — it has NEVER stopped since the day you were born! What do you think makes your moyo beat the very fastest?"
    ...
    nywele (hair):    "Run your hand over the top of your head — feel your nywele! It grows a little bit every single day, without you doing anything at all! What do you do to your nywele every morning when you wake up?"
    ...
    damu (blood):     "Right this second, your damu is travelling through your ENTIRE body — from your heart all the way to your toes and back — non-stop! Have you ever seen a tiny drop of damu from a small cut?"
    ...
    mapafu (lungs):   "Right now, your mapafu are working — breathing in, breathing out — without you even thinking about it! Take one deep breath and feel your mapafu expand all the way! What do you think would happen to your mapafu if you lived very high on Mount Kilimanjaro?"
    ...
    jasho (sweat):    "When you run hard or the sun is really hot — your body makes jasho all over your skin! Jasho is actually your body's built-in air conditioning — it cools you down! When do you get the most jasho — exercise, hot weather, or something scary?"
    machozi (tears):  "Machozi — tears — are not just for sadness! You cry when you are too happy, too sleepy, or when you cut onions! And machozi actually keep your eyes healthy. When was the last time machozi came to your eyes?"
...
##`);
    ...
    shangazi:   "Shangazi is your aunt — like a second mother sometimes! Does your shangazi visit your family often?"
    ...
    daktari:    "Imagine you are really sick — your stomach hurts, your head is burning, nothing is helping — and then someone comes in, figures out exactly what is wrong, and makes you better. That is a daktari! Have you ever visited one — what was it like?"
    ...
    mkulima:    "Every single meal you eat — the rice, the beans, the tomatoes, the vegetables — every bit of it started with a mkulima's hands in the soil, watering and waiting! Do you know any mkulima near where you live?"
    dereva:     "Think of every time you sat in a minibus or a bus going somewhere exciting — there is always a dereva in front, eyes on the road, getting everyone there safely! Who is a dereva that has taken YOU somewhere — where did you go?"` : `    mama:       "Mama — mtu anayekupenda zaidi! Anapika chakula chako, anakushika ukiwa mgonjwa, na daima anajua kama kitu kiko vibaya! Ni nini mama yako anachofanya kinachokufanya uhisi furaha zaidi?"
