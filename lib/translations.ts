  ...
  en: {
    ...
    settings: {
      ...
      toggles: [
        ...
        { label: "Game Sounds",       desc: "Chimes and vibrations in the word games — never during voice lessons" },
      ],
  ...
  sw: {
    ...
    settings: {
      ...
      toggles: [
        ...
        { label: "Sauti za Michezo",        desc: "Milio na mitetemo kwenye michezo ya maneno — kamwe si wakati wa masomo ya sauti" },
      ],
